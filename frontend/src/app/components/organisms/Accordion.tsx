...
// export const Accordion: FC<AccordionProps> = ({ panel, data, onSubcategoryClick }) => {
...
//         <div key={index} className={`accordion ${open === index + 1 ? styles.accordionOpen : ''}`}>
...
//             {Object.keys(data[categoryName]).map(p => +p).map((paramId, subIndex) => (
//               <div
//                 key={paramId}
//                 onClick={() => handleSubcategoryClick(paramId)}
//                 className={styles.Maccordion__subcategory}
//               >
//                 {data[categoryName][paramId as number]}
//               </div>
//             ))}
//           </div>
//         </div>
